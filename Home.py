        ...
        if on_main_dashboard:
            ...
            if df_csv['Title'].any() in ("", [], None, 0, False):
                ...
                def author_chart():
                    ...
                    df['% Multiple Authored Publications'] = round(df_multiple_authors['# Multiple Authored Publications']/df_multiple_authors['Total Publications'], 3)*100
                    df['% Single Authored Publications'] = round(df_multiple_authors['# Single Authored Publications']/df_multiple_authors['Total Publications'], 3)*100
                    df_multiple_authors
