...
df_gs['organiser'] = df_gs['organiser'].str.replace('North American Society for Intelligence History (NASIH)', 'The Society for Intelligence History (SIH)', case=False)
df_gs
...
df_forms['organiser'] = df_forms['organiser'].str.replace('North American Society for Intelligence History (NASIH)','The Society for Intelligence History (SIH)')
