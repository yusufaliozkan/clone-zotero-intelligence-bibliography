                        ...
                        with st.status("Searching publications...", expanded=True) as status:
                            ...
                            if not filtered_df.empty:
                                ...
                                if on and len(filtered_df) > 0: 
                                    ...
                                    filtered_df_for_collections = filtered_df_for_collections[['Zotero link', 'Collecction_Key', 'Collection_Name', 'Collection_Link']]
                            ...
                            status.update(
                                label=f"Search found **{num_items}** {'matching source' if num_items == 1 else 'matching sources'} in the database.", 
                                state="complete", 
                                expanded=True
                                )
                    else:
